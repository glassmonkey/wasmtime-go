...
// gets a dedicated downcast method and a test path that exercises it.
...
const (
	...
	// Composite-kind constants are deferred until each gets an exercised
	// downcast method. Uncomment when the corresponding sub-type wrapper
	// + test arrives.
	//
...
// — those, along with their downcast methods, arrive in follow-up work.
