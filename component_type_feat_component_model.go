...
//
// The kind discriminates between seven sub-types; this release exposes a
// downcast for type-alias entries via [ComponentItem.TypeAlias]. Downcasts
// for the remaining kinds (component, component-instance, module,
// component-func, resource, core-func) will be wired up in follow-up work.
